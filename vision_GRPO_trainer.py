...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def __init__(
        ...
        if processing_class is None:
            ...
            #TODO: fixed, check if it is correct 
            # Se processing_class è già fornito, estrai pad_token_id
        ...
        self._last_loaded_step = -1  #TODO: fixed, check if it is correct
    ...
    def _get_train_sampler(self, train_dataset=None) -> Sampler:
        ...
        return RepeatRandomSampler(
            data_source=self.train_dataset if train_dataset is None else train_dataset,  #TODO: fixed: check if it is correct
    ...
    def _generate_and_score_completions(
        ...
        is_eos = completion_ids == self.processing_class.tokenizer.eos_token_id #TODO: fixed, check if it is correct
        ...
        rewards_per_func = torch.zeros(len(completions), len(self.reward_funcs), device=device) #TODO: fixed, check if it is correct
        print(f"rewards_per_func:  Number of completions --> {len(completions)}")
